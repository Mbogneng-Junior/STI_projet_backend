...
from module_expert.tools.descriptions import DESC_UROLOGIE, INSTR_UROLOGIE, KEY_EXPERT_ANALYSIS

# Import des 3 outils nécessaires
from .tools.expert_tools import search_uro_cases
...
urologie_expert = Agent(
    name="Expert_Urologie",
    model=MODEL_NAME,
    description=DESC_UROLOGIE,
    instruction=INSTR_UROLOGIE,
    tools=[
        lire_conversation,      # Indispensable pour voir le chat
        search_uro_cases,    # Spécifique au domaine
